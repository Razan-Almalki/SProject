...
if ($result->num_rows > 0) {
    ...
    echo "<input type='radio' id='attend' name='attendance' value='حضور'><label for='attendance'>حضور</label>";
    echo "<input type='radio' id='decline' name='attendance' value='معتذر'><label for='attendance'>اعتذار</label>";
    echo "</div>";
    echo "</div>";
